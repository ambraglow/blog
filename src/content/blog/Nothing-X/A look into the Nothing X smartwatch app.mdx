...
<p style="font-size: 12px; text-align: left; font-style: italic; margin-top: 0px;">**little side note:** for future reference, there's something i just noticed in the app's readme: "For rooted devices, the [pcapd daemon](https://github.com/emanuele-f/PCAPdroid/tree/master/app/src/main/jni/pcapd) can be directly integrated into your APK to capture network packets."</p>
...
<div style="display: flex; flex-direction: row; gap: 1rem;" >
    <Image src={classdirs} alt="" style="width: 30%; margin: 1rem; position: relative;"/>
    <Image src={classdirs2} alt="" style="width: 30%; margin: 1rem; position: relative;"/>
</div>
...
<Image src={loggermethods} alt=""/>
<br></br>
<Image src={loggeruse} alt=""/>
