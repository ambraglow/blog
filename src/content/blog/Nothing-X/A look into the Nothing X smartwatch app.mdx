...
Anyway, this means i finally have an occasion to tinker with my watch, by grabbing the firmware update i could definitely find out more about it. So i start figuring out a plan and decide to postpone updating its firmware for a while.
