...
- i found out quite early from the Chinese slice of the internet that the main processor is an [Action-Tech/Semi ATS3089C](https://www.52audio.com/archives/265085.html)[^1].
...
[Moving on](https://www.youtube.com/watch?v=qeMFqkcPYcg), i tried what worked for me in the past in a similar situation - For a different smartwatch, at the time i was hacking on a Samsung Fit 3 - the method i used was to run [PCAPDroid](https://github.com/emanuele-f/pcapdroid) on my phone to capture traffic and analyze it later.
Previously, Samsung sent their firmware update through a non-encrypted connection (just HTTP) which allowed me to simply recover the image from the capture.
